...
if (!$time) {
    ...
    header('Location: ../team/manage.php');
    exit();
}
...
if (isset($_POST['remove_user_id'])) {
    ...
    header("Location: manage_members.php?id=$timeId");
    exit();
}
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="manage_members.php?id=<?php echo htmlspecialchars($timeId); ?>">
