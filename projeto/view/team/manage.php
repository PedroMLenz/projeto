...
<body>
    <div class="container">
        ...
        <div class="emcima">
            <button class="button" onclick="window.location.href='create_edit.php'">Criar Novo Time</button>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="button-container">
                                <?php if ($isCapitao): ?>
                                <button class="button"
                                    onclick="window.location.href='manage_members.php?id=<?php echo htmlspecialchars($time['id']); ?>'">Gerenciar
                                    Membros</button><br>
                                <button class="button"
                                    onclick="window.location.href='create_edit.php?id=<?php echo htmlspecialchars($time['id']); ?>'">Editar</button>
