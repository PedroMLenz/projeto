...
<body>
    <div class="container">
        ...
        <div class="cima">
            <button class="button" onclick="window.location.href='criar.php'">Criar Nova Partida</button>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-container">
                            <a href="editar.php?id=<?php echo htmlspecialchars($partida['id']); ?>"
        ...
        <table class="table2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-container">
                            <a href="visualizar.php?id=<?php echo htmlspecialchars($partida['id']); ?>"
